...
>[!image] `Eddies`
><img src="../Attached Files/vortex.gif" />
...
<img src="../Attached Files/turbulence.png" />
## 난류 운동 에너지
...
### 1. 난류의 세기를 추정하는 척도
- 난류 운동 에너지 ($k$)의 값이 크면 난류 변동이 강하다. $k=0$이면 해당 평균 방식에서 속도 변동이 없다는 뜻이며, 유동은 층류일 수 있지만 평균 유동이 정지했다는 뜻은 아니다.
...
$$
\nu_{t}=C_{\mu}\frac{k^{2}}{\varepsilon}\quad(k\text{-}\varepsilon\text{ 모델의 대표적 형태}),\qquad \nu_t\propto\frac{k}{\omega}\quad(k\text{-}\omega\text{ 계열})
$$
### 3. 에너지 전달 해석
