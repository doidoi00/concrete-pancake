...
### 시간 평균, 공간 평균 (Time Average, Spatial Average)
...
<img src="../Attached Files/turbvel.png" align="center" width="50%"/>
...
<img src="../Attached Files/spacial_average.jpg" align="center" width="50%"/>
...
[[나비에-스토크스 방정식(Navier-Stokes Equations)|나비에-스토크스 방정식]]에 레이놀즈 분해를 적용하면 Reynolds-Averaged Navier-Stokes equations(RANS)가 유도되며, 이 방정식을 통해 난류 평균 흐름을 예측하는 실용적인 도구로 활용할 수 있다. 또한 변동 유속의 상관으로 레이놀즈 응력을 정의하고 난류 모형을 설계할 수 있다.
...
- 평균 성분은 평균 연산에 대해 상수이므로 변동 성분과의 평균 곱이 0이다. 이것이 일반적인 통계적 독립을 뜻하지는 않는다.
- 편차는 평균값에 더 이상 영향을 주지 않는다.
- 물리적 의미: $\overline{\phi'}=0$인 평균 연산의 성질이다. 변동 성분은 에너지와 방향성을 모두 가질 수 있으며, 이 성질만으로 독립성이나 등방성을 결론 내릴 수는 없다.
---
### 6. 곱의 평균 $\ne$ 각 평균의 곱
