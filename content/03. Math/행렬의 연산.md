...
$$
c_{ij}=\mathrm{row_{i}A \;col_{j}B}=a_{i1}b_{1 j}+a_{i 2}b_{2j}+ \cdots +a_{in}b_{nj}=\sum\limits_{k=1}^{n} a_{ik}b_{kj}
$$
...
<img class="tikzjax-png" src="/static/tikz/6ddcb61ec76f66e5.png" data-light-src="/static/tikz/6ddcb61ec76f66e5.png" data-dark-src="/static/tikz/6ddcb61ec76f66e5-dark.png" id="png-6ddcb61ec76f66e5" alt="tikz" width="50%">
